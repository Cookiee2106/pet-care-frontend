          ...
          <Card className='shadow mb-5'>
            ...
            <Card.Body>
              ...
              <Form.Group as={Col} controlId='gender' className='mb-2'>
                <Form.Label className='legend'>Giới tính</Form.Label>
                <Form.Control
                  as='select'
                  name='gender'
              ...
              <Form.Group as={Col} controlId='gender' className='mb-2'>
                <Form.Label className='legend'>Loại người dùng</Form.Label>
                <Form.Control
                  type='text'
                  name='userType'
              ...
              {userData.userType === "VET" && (
                <Form.Group controlId='specialization' className='mb-4'>
                  <Form.Label className='legend'>Chuyên khoa</Form.Label>
              ...
              <div className='d-flex justify-content-center'>
                <div className='mx-2'>
                  <Button
                    ...
                    {isProcessing ? (
                      <ProcessSpinner message='Đang xử lý cập nhật...' />
                    ) : (
                      "Cập nhật"
                    )}
                  </Button>
