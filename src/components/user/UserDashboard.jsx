  ...
  return (
    <Container className='mt-2 user-dashboard'>
      <Tabs
        ...
        <Tab eventKey='profile' title={<h3>Hồ sơ</h3>}>
          <Col>
            {showErrorAlert && (
        ...
        <Tab eventKey='status' title={<h3>Tổng quan lịch hẹn</h3>}>
          <Row>
            <h4 className='text-center mt-4'>Tổng quan lịch hẹn</h4>
            <Col>
              {appointmentData && appointmentData.length > 0 ? (
                <CustomPieChart data={appointmentData} />
              ) : (
                <NoDataAvailable dataType={"lịch hẹn"} />
              )}
            </Col>
          </Row>
        </Tab>
        ...
        {isCurrentUser && (
          <Tab eventKey='appointments' title={<h3>Chi tiết lịch hẹn</h3>}>
            {" "}
            <Row>
              <Col>
                {user && (
        ...
        <Tab eventKey='reviews' title={<h3>Đánh giá</h3>}>
          <Container className='d-flex justify-content-center align-items-center'>
            <Card className='mt-5 mb-4 review-card'>
              <h4 className='text-center mb-2'>Đánh giá của bạn</h4>
              <hr />
              <Row>
                <Col>
                  {user && user.reviews && user.reviews.length > 0 ? (
                    ...
                    <NoDataAvailable dataType={"đánh giá"} />
                  )}
                </Col>
              </Row>
            </Card>
